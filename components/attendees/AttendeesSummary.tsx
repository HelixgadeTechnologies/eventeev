...
const SummaryCard: React.FC<SummaryCardProps> = ({ label, value, icon, trend, trendLabel }) => (
  <div className="bg-white border border-gray-100 rounded-[16px] p-6 flex flex-col justify-between h-[140px] shadow-sm">
