    ...
    <section className="space-y-8 font-sans">
      ...
      <div className="flex flex-col md:flex-row md:items-end justify-between gap-4">
        <div className="space-y-1">
          ...
          <h2 className="text-3xl font-black text-[#1B1818] tracking-tight">Calendar & Reminders</h2>
          <p className="text-sm text-gray-400 font-medium">Track deadlines, milestones, and important reminders for your event.</p>
        </div>
